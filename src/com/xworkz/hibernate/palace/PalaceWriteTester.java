package com.xworkz.hibernate.palace;
	...
	Map<String, Object[]> data = new TreeMap<String, Object[]>();
	        ...
	        data.put("2", new Object[] {1,"Bangalore Palace","Rev. J. Garrett",1878,"Karnataka","Bangalore","India"});
	        data.put("3", new Object[] {2,"Taj Falaknuma Palace","Nizam",1894,"Telangana","Hyderabad","India"});
	        data.put("4", new Object[] {3,"Padmanabhapuram Palace","Ravi Varma Kulasekhara perumal",1601,"Tamilnadu","Kanyakumari","India"});
